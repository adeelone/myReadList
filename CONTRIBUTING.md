...
5. Keep all runtime dependencies local. New third-party scripts, analytics, embeds, or network calls require an explicit privacy and security review.

Report vulnerabilities through the private channel described in `SECURITY.md`, not through a pull request or public issue.
